...
print('все значения:', d.values()) # выведет все значения - dict_values(['значение*', 'значение#'])
print('Все ключи: ', d.keys()) # выведет все ключи - dict_keys(['ключ', 'ключ1'])
#
# добавление
...
'''Условие: Влесу живут разные животные, и у каждого есть свой домик с номером.Информация
о животных и номерах их домиков записана в словаре, где ключ — это имя животного, 
